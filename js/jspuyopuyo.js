...
//게임 클릭 시 스크롤방지
var puyogameElem = document.querySelector(".puyogame");
puyogameElem.onmouseover = function () {
    addClass(document.querySelector("body"), "disableScroll");
};
puyogameElem.onmouseout = function () {
    removeClass(document.querySelector("body"), "disableScroll");
};
//뿌요 색상 클래스 지정
...
function initGame() {
    ...
    //set puyotable
    var temprand = Math.round(rand() * 5);
